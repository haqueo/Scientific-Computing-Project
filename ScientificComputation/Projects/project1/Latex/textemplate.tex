...
Firstly we note that from the first question where we found the maximum load for all cars over the 200 iterations, it is clear that 

For a lot of these edges [a,b], they are moving completely in the opposite direction that the straight line drawn from node a to node 52 would go.
